...
class HelpIntent
{
    ...
    {
        $this -> responseText = 'Ask for Madison Metro bus and route number information. For example, say, "Hey Alexa, ask Madison Metro for stop number one one zero one route seventy."';
